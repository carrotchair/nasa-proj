...
| ----------------------------- | ------------------------------------| -----------------------------------------------|
|NASA_API_URL           | URL of Nasa API               | -      |
|NASA_API_KEY           | API KEY generated by Nasa     | -      |
|PORT                   | port                          | -      |
|NASA_ROVER_URL         | URL of Nasa rover photo API   | -      |
|SOL                    | URL od Nasa API               | -      |


# Pre-requisites
- Install [Node.js](https://nodejs.org/en/) v20.18.0
- Install [Express](https://expressjs.com/en/starter/installing.html) express@4.21.1
...
# Node.js
The main purpose of this repository is to learn Node.js while knowing basics of JS.
